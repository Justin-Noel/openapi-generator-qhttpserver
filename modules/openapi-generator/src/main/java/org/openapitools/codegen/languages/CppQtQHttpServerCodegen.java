...
public class CppQtQHttpServerCodegen extends CppQtAbstractCodegen implements CodegenConfig {
    ...
    public CppQtQHttpServerCodegen() {
        super();

        modifyFeatureSet(features -> features.includeDocumentationFeatures(DocumentationFeature.Readme));

        // set the output folder here
        outputFolder = "generated-code/cpp-qt-qhttpserver";
         ...
         */
        embeddedTemplateDir = templateDir = "cpp-qt-qhttpserver";
    ...
    public String getHelp() {
        return "Generates a Qt 6.5+ C++ Server using the QHttpServer module (built-in to Qt 6).";
    }
